                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
								<td align="center" valign="top" id="templatePreheader">
									<button id="print" onclick="myPrnt()" type="button">Cetak</button>
									<!--[if (gte mso 9)|(IE)]>
                    ...
                    <table class="mcnImageContentContainer" style="min-width:100%;" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                        <tbody><tr>
                            <td class="mcnImageContent" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;" valign="top">
                                        ...
                                        <img alt="" src="{{asset('images/logo.png')}}" style="max-width:200px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage" width="200" align="middle">
                ...
                <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                    <tbody><tr>
                        ...
                        <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                            ...
                            <h1>E-Ticket</h1>
{{"airport"}} - {{date('l, d M Y', strtotime($d->transaction->updated_at))}}<!--Wednesday, 6 Feb 2018-->
                        </td>
                    </tr>
                </tbody></table>
				<!--[if mso]>
				...
				<![endif]-->
                            ...
                            <tr>
								<td align="center" valign="top" id="templateFooter">
									...
									<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer">
										<tr>
                                			<td valign="top" class="footerContainer"><table class="mcnDividerBlock" style="min-width:100%;" width="100%" cellspacing="0" cellpadding="0" border="0">
                            ...
                            <table class="mcnTextContentContainer" style="min-width: 100% !important;background-color: #404040;" width="100%" cellspacing="0" border="0">
                                <tbody><tr>
                                    <td class="mcnTextContent" style="padding: 18px;color: #F2F2F2;font-family: Helvetica;font-size: 14px;font-weight: normal;text-align: center;" valign="top">
                                        <div style="text-align: left;"><u><span style="font-size:18px"><strong>#{{$d->id}}</strong></span></u><br>
<span style="font-size:18px"><strong>Penumpang:</strong></span><br>
&nbsp;</div>
@foreach ($pas as $p)
                    ...
                    <tbody><tr>
                        ...
                        <td class="mcnBoxedTextContentColumn" style="padding-top:9px; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <table class="mcnTextContentContainer" style="min-width: 100% !important;background-color: #404040;" width="100%" cellspacing="0" border="0">
                                <tbody><tr>
                                    <td class="mcnTextContent" style="padding: 18px;color: #F2F2F2;font-family: Helvetica;font-size: 14px;font-weight: normal;text-align: center;" valign="top">
                                        <div style="text-align: center;"><span style="font-size:18px"><strong><u>Itinerary</u></strong></span><br>
&nbsp;</div>
@foreach ($sche as $s)
@if ($d->vehicle == "train")
<div style="text-align: center;"><span style="font-size:14px">{{$s->train->train_name}}<br>
  Platform<br>
  <b>{{$s->platform}}</b>
  <br>
@elseif ($d->vehicle == "plane")
  <div style="text-align: center;"><span style="font-size:14px">{{$s->plane->plane_name}}<br>
    Gate<br>
    <b>{{$s->gate}}</b>
    <br>
@endif
...
<div style="text-align: center;"><span style="font-size:12px">{{$s->from}} ({{$s->from_code}})<br>
{{date('l, d M Y', strtotime($s->boarding_time))}}<br>
Pukul {{date('h:i', strtotime($s->boarding_time))}}<br>
<br>
Tujuan :<br>
{{$s->destination}} ({{$s->destination_code}})<br>
{{date('l, d M Y', strtotime($s->boarding_time))}}<br>
Pukul {{date('h:i', strtotime($s->boarding_time)+ $s->duration)}}<br>
@endforeach
...
@endforeach
		...
		function myPrnt() {
			...
			// function aww() {
			// 	// $('#myPrntBtn').hide;
			// 	var btn = getElementById('myPrntBtn');
			// 	alert(btn);
			// 	// window.print();
			// }
		</script>
